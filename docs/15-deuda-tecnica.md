...
| DT-003 | P0        | Contenido     | `indo-pacifico.md` es placeholder fuera de colección                    | Página pública inconsistente                                     | Resuelto          |
| DT-004 | P0        | Conversión    | Ko-fi usaba un identificador ficticio                                   | URL real centralizada y sistema controlado mediante feature flag | Resuelto          |
